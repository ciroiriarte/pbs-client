...
Architecture: any
Build-Depends: debhelper (>= 13~), pbs-client-rust, gcc, clang, libclang-dev, pkgconf, libfuse3-dev, libssl-dev, libzstd-dev, libacl1-dev, libsystemd-dev, libcrypt-dev, uuid-dev, zstd
