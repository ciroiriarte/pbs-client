...
Architecture: any
Build-Depends: debhelper (>= 13~), gcc, clang, libclang-dev, pkgconf, pkg-config, xz-utils, libfuse3-dev, libssl-dev, libzstd-dev, libacl1-dev, libsystemd-dev, libcrypt-dev, uuid-dev, zstd
