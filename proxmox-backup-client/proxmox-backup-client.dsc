...
Architecture: any
Build-Depends: debhelper (>= 13~), cargo, rustc (>= 1.81), clang, libclang-dev, pkg-config, libfuse3-dev, libssl-dev, libzstd-dev, libacl1-dev, libsystemd-dev, uuid-dev, zstd
