...
Architecture: any
Build-Depends: debhelper (>= 13~), cargo (>= 1.87), rustc (>= 1.87), clang, libclang-dev, pkg-config, libfuse3-dev, libssl-dev, libzstd-dev, libacl1-dev, libsystemd-dev, libcrypt-dev, uuid-dev, zstd
